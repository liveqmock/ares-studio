...
import com.hundsun.ares.studio.atom.compiler.mysql.token.PackAddFieldHeadToken;
...
public class PackAddFieldByHandworkMacroHandler implements IMacroTokenHandler {
	...
	private void addObjectPackToVarList(String packName,Map<Object, Object> context){
		...
		if(StringUtils.startsWith(packName, "@") && StringUtils.endsWith(packName, "ResultSet")){
			...
			helper.addAttribute(IAtomEngineContextConstantMySQL.ATTR_OUT_OBJECT_INIT_VARIABLE_LIST, objectName);
			...
			helper.addAttribute(IAtomEngineContextConstantMySQL.ATTR_OUT_OBJECT_INIT_VARIABLE_LIST, varName);
			popObjectVarList.add(varName);
