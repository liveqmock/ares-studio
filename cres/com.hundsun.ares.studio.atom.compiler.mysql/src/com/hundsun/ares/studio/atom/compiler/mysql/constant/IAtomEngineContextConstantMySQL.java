...
*/
package com.hundsun.ares.studio.atom.compiler.mysql.constant;

/**
 * @author lvgao
 *
 */
public interface IAtomEngineContextConstantMySQL {
	...
	public static final String ATTR_STATEMENT_LIST = "动态语句列表";//lpSP列表，ICallableStatement * lpSP{objId}+{orderId} = lpConn->createCallableStatement();
