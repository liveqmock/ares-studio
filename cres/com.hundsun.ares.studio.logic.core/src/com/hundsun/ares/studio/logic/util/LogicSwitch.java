...
public class LogicSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LogicPackage.LOGIC_FUNCTION: {
				...
				if (result == null) result = caseAtomFunction(logicFunction);
				if (result == null) result = caseBizInterface(logicFunction);
				if (result == null) result = caseJRESResourceInfo(logicFunction);
				if (result == null) result = caseExtensibleModel(logicFunction);
				if (result == null) result = caseBasicResourceInfo(logicFunction);
				if (result == null) result = caseIReferenceProvider(logicFunction);
				if (result == null) result = caseIJSONData(logicFunction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LogicPackage.LOGIC_SERVICE: {
				LogicService logicService = (LogicService)theEObject;
				T result = caseLogicService(logicService);
				if (result == null) result = caseAtomFunction(logicService);
				if (result == null) result = caseBizInterface(logicService);
				if (result == null) result = caseJRESResourceInfo(logicService);
				if (result == null) result = caseExtensibleModel(logicService);
				if (result == null) result = caseBasicResourceInfo(logicService);
				if (result == null) result = caseIReferenceProvider(logicService);
				if (result == null) result = caseIJSONData(logicService);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseLogicService(LogicService object) {
		return null;
	}
