...
public class AtomSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AtomPackage.ATOM_FUNCTION: {
				AtomFunction atomFunction = (AtomFunction)theEObject;
				T result = caseAtomFunction(atomFunction);
				if (result == null) result = caseBizInterface(atomFunction);
				if (result == null) result = caseJRESResourceInfo(atomFunction);
				if (result == null) result = caseExtensibleModel(atomFunction);
				if (result == null) result = caseBasicResourceInfo(atomFunction);
				if (result == null) result = caseIReferenceProvider(atomFunction);
				if (result == null) result = caseIJSONData(atomFunction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AtomPackage.ATOM_SERVICE: {
				AtomService atomService = (AtomService)theEObject;
				T result = caseAtomService(atomService);
				if (result == null) result = caseAtomFunction(atomService);
				if (result == null) result = caseBizInterface(atomService);
				if (result == null) result = caseJRESResourceInfo(atomService);
				if (result == null) result = caseExtensibleModel(atomService);
				if (result == null) result = caseBasicResourceInfo(atomService);
				if (result == null) result = caseIReferenceProvider(atomService);
				if (result == null) result = caseIJSONData(atomService);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseAtomFunction(AtomFunction object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseAtomService(AtomService object) {
		return null;
	}
