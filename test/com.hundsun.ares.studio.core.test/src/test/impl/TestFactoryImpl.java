...
public class TestFactoryImpl extends EFactoryImpl implements TestFactory {
	...
	public static TestFactory init() {
		try {
			TestFactory theTestFactory = (TestFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.hundsun.com/ares/studio/core/test"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TestPackage.TEST_INFO: return createTestInfo();
			default:
