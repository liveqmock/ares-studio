...
public class TestAdapterFactory extends AdapterFactoryImpl {
	...
	protected TestSwitch<Adapter> modelSwitch =
		new TestSwitch<Adapter>() {
			@Override
			public Adapter caseTestInfo(TestInfo object) {
				return createTestInfoAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link test.TestInfo <em>Info</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTestInfoAdapter() {
		return null;
	}
