...
public class ProcedureItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addProcNamePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Proc Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addProcNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Procedure_procName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Procedure_procName_feature", "_UI_Procedure_type"),
				 ProcdurePackage.Literals.PROCEDURE__PROC_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		newChildDescriptors.add
			(createChildParameter
				(BizPackage.Literals.BIZ_INTERFACE__INPUT_PARAMETERS,
				 ProcdureFactory.eINSTANCE.createInternalParam()));
