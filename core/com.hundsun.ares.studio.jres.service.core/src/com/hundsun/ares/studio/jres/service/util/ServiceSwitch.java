	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ServicePackage.SERVICE: {
				...
				if (result == null) result = caseJRESResourceInfo(service);
				if (result == null) result = caseExtensibleModel(service);
				if (result == null) result = caseBasicResourceInfo(service);
				if (result == null) result = caseIReferenceProvider(service);
				if (result == null) result = caseIJSONData(service);
