...
/**
 * This is the item provider adapter for a {@link com.hundsun.ares.studio.jres.model.database.ForeignKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForeignKeyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ForeignKey_tableName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ForeignKey_tableName_feature", "_UI_ForeignKey_type"),
	...
	protected void addFieldNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ForeignKey_fieldName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ForeignKey_fieldName_feature", "_UI_ForeignKey_type"),
				 DatabasePackage.Literals.FOREIGN_KEY__FIELD_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ForeignKey)object).getTableName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ForeignKey.class)) {
			case DatabasePackage.FOREIGN_KEY__TABLE_NAME:
			case DatabasePackage.FOREIGN_KEY__FIELD_NAME:
