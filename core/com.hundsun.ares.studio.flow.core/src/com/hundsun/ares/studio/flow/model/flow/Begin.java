 ...
 * <ul>
 *   <li>{@link com.hundsun.ares.studio.flow.model.flow.Begin#getFigureNode <em>Figure Node</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.hundsun.ares.studio.flow.model.flow.FlowPackage#getBegin()
 * @model abstract="true"
 * @generated
 */
public interface Begin extends IViewProvider {
	/**
	 ...
	 * @see com.hundsun.ares.studio.flow.model.flow.FlowPackage#getBegin_FigureNode()
	...
	/**
	 * Sets the value of the '{@link com.hundsun.ares.studio.flow.model.flow.Begin#getFigureNode <em>Figure Node</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
