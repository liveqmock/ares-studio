...
/**
 * This is the item provider adapter for a {@link com.hundsun.ares.studio.flow.model.flow.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addColorViewPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FlowPackage.Literals.CONNECTION__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FlowPackage.Literals.CONNECTION__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Color View feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addColorViewPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_colorView_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_colorView_feature", "_UI_Connection_type"),
				 FlowPackage.Literals.CONNECTION__COLOR_VIEW,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_value_feature", "_UI_Connection_type"),
				 FlowPackage.Literals.CONNECTION__VALUE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FlowPackage.Literals.CONNECTION__BENDPOINTS);
		}
	...
	public String getText(Object object) {
		String label = ((Connection)object).getValue();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FlowPackage.Literals.CONNECTION__BENDPOINTS,
				 FlowFactory.eINSTANCE.createBendpoint()));
	}
