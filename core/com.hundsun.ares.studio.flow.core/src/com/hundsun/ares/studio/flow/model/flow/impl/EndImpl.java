 ...
 * <ul>
 *   <li>{@link com.hundsun.ares.studio.flow.model.flow.impl.EndImpl#getFigureNode <em>Figure Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class EndImpl extends IViewProviderImpl implements End {
	/**
	...
	public NotificationChain basicSetFigureNode(FigureNode newFigureNode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FlowPackage.END__FIGURE_NODE, oldFigureNode, newFigureNode);
	...
	public void setFigureNode(FigureNode newFigureNode) {
		if (newFigureNode != figureNode) {
			...
			if (figureNode != null)
				msgs = ((InternalEObject)figureNode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FlowPackage.END__FIGURE_NODE, null, msgs);
			if (newFigureNode != null)
				msgs = ((InternalEObject)newFigureNode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FlowPackage.END__FIGURE_NODE, null, msgs);
			msgs = basicSetFigureNode(newFigureNode, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.END__FIGURE_NODE, newFigureNode, newFigureNode));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FlowPackage.END__FIGURE_NODE:
