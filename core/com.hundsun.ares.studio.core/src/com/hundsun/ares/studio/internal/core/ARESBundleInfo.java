 ...
 * @author sundl
 */
public class ARESBundleInfo extends ExtendAbleModel implements IARESBundleInfo{
	...
	private String type;		// 类型（项目的nature）
	
	private Map<String, Object> properties = new HashMap<String, Object>();
	
	protected List<IDependenceDescriptor> dependencies = new ArrayList<IDependenceDescriptor>();
	...
	public void setDependencies(List<IDependenceDescriptor> dependencies) {
