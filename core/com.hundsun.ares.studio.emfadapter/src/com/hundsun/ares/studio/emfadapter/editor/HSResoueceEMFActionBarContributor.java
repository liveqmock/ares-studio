...
public class HSResoueceEMFActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
...
//					ForumEditorPlugin.INSTANCE.log(exception);
	 ...
	 * @generated
	 */
	public HSResoueceEMFActionBarContributor() {
...
//		toolBarManager.add(new Separator("forum-settings"));
//		toolBarManager.add(new Separator("forum-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager("&Forum Editor", "com.ibm.example.emf.forumMenuID");
...
//
		...
		cutAction.setEditingDomain(domain);
		copyAction.setEditingDomain(domain);
		pasteAction.setEditingDomain(domain);
		
		
		undoAction.setEditingDomain(domain);
		redoAction.setEditingDomain(domain);
		
//		deleteAction = new DeleteAction(domain);
