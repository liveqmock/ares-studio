...
public abstract class AbstractHSFormEditorEMFAdapter<T extends EObject> 
	extends AbstractHSFormEditor<T>
		...
		public void partActivated(IWorkbenchPart p) {
			if (p instanceof ContentOutline) {
				if (((ContentOutline)p).getCurrentPage() == contentOutlinePage) {
					getActionBarContributor().setActiveEditor(AbstractHSFormEditorEMFAdapter.this);
//					setCurrentViewer(contentOutlineViewer);
			...
			else if (p == AbstractHSFormEditorEMFAdapter.this) {
				handleActivate();
			}
		}
	...
	public AbstractHSFormEditorEMFAdapter() {
		super();
	...
	protected void handleActivate() {
		...
		if (editingDomain.getResourceToReadOnlyMap() != null) {
		    ...
		    for(Resource res:editingDomain.getResourceSet().getResources()){
		    	editingDomain.getResourceToReadOnlyMap().put(res, isReadOnly());
		    }
...
//		}
		...
		editingDomain.getResourceToReadOnlyMap().put(xmlResource, isReadOnly());
	...
	protected void createSourcePage() {
		ViewerPane viewerPane =
			new ViewerPane(getSite().getPage(), AbstractHSFormEditorEMFAdapter.this) {
				@Override
			...
			propertySheetPage =
				new ExtendedPropertySheetPage(editingDomain) {
					...
					public void setSelectionToViewer(List<?> selection) {
						AbstractHSFormEditorEMFAdapter.this.setSelectionToViewer(selection);
						AbstractHSFormEditorEMFAdapter.this.setFocus();
					}
