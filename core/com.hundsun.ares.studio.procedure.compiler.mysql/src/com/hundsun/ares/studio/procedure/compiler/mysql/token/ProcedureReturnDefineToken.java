...
public class ProcedureReturnDefineToken implements ICodeToken {
	...
	public String genCode(Map<Object, Object> context) throws Exception {
		...
		if(StringUtils.isBlank(procedure.getBizType()) ||
				StringUtils.equalsIgnoreCase(procedure.getBizType(), IProcedureEngineContextConstantMySQL.function)){
			//result.append("returns int");
			//result.append(StringUtils.isBlank(procedure.getReturnType())?"int":procedure.getReturnType());
			result.append(NEWLINE);
		}
