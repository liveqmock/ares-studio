...
/**
 * This is the item provider adapter for a {@link com.hundsun.ares.studio.jres.model.metadata.MenuItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MenuItemItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MenuItem_url_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MenuItem_url_feature", "_UI_MenuItem_type"),
	...
	protected void addIconPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MenuItem_icon_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MenuItem_icon_feature", "_UI_MenuItem_type"),
				 MetadataPackage.Literals.MENU_ITEM__ICON,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetadataPackage.Literals.MENU_ITEM__SUB_ITEMS);
			childrenFeatures.add(MetadataPackage.Literals.MENU_ITEM__FUNCTION_PROXYS);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(MetadataPackage.Literals.MENU_ITEM__FUNCTION_PROXYS,
				 MetadataFactory.eINSTANCE.createFunctionProxy()));
	}
