...
/**
 * This is the item provider adapter for a {@link com.hundsun.ares.studio.jres.model.metadata.DictionaryType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DictionaryTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetadataPackage.Literals.DICTIONARY_TYPE__ITEMS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DictionaryType.class)) {
			case MetadataPackage.DICTIONARY_TYPE__ITEMS:
		...
		newChildDescriptors.add
			(createChildParameter
				(MetadataPackage.Literals.DICTIONARY_TYPE__ITEMS,
				 MetadataFactory.eINSTANCE.createDictionaryItem()));
	}
