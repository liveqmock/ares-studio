...
public class LongBasicDataTextEditingSupport extends EMFEditingSupport {
	 ...
	 */
	public LongBasicDataTextEditingSupport(ColumnViewer viewer,
	...
	protected CellEditor doGetCellEditor(Object element) {
		...
		BasicDataTextAndDialogCellEditor celleditor = (BasicDataTextAndDialogCellEditor) super.doGetCellEditor(element);
	...
	protected CellEditor createCellEditor() {
		...
		return new BasicDataTextAndDialogCellEditor((Composite)getViewer().getControl()) {
			@Override
