...
public class MasterSlaveDetailViewerBlock extends TableViewerBlock {
...
//	private ColumnViewerPasteAction pasteAction;
	 ...
	 * @param problemPool
	 */
	public MasterSlaveDetailViewerBlock(
...
//		pasteAction.setReference(MetadataPackage.Literals.DICTIONARY_TYPE__ITEMS);
	...
	protected void createColumns(TableViewer columnViewer) {
		...
		//过滤name/chineseName/description/refID几个属性
		...
		//扩展模型
		ExtensibleModelUtils.createExtensibleModelTableViewerColumns(treeViewer, getARESResource(), slaveEclass, problemView);
