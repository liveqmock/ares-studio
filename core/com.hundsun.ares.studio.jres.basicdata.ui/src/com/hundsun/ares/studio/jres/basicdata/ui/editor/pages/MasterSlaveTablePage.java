...
import com.hundsun.ares.studio.jres.basicdata.ui.editor.blocks.MasterSlaveDetailViewerBlock;
 ...
 *
 */
public class MasterSlaveTablePage extends AbstractMetadataFormPage {
		
	private static Logger logger = Logger.getLogger(MasterSlaveTablePage.class);
	
	private SingleTableListViewerBlock masterListViewerBlock;
	private MasterSlaveDetailViewerBlock slaveDetailViewerBlock;
	 ...
	 * @param title
	 */
	public MasterSlaveTablePage(EMFFormEditor editor, String id, String title) {
	 ...
	 */
	public MasterSlaveDetailViewerBlock getSlaveDetailViewerBlock() {
		return slaveDetailViewerBlock;
	}
	...
	protected void createMetadataComposite(Composite body, FormToolkit toolkit) {
		...
		slaveDetailViewerBlock = new MasterSlaveDetailViewerBlock(getEditingDomain(), 
				getEditor().getARESResource(), 
				getProblemPool(),
				epackage
				);
