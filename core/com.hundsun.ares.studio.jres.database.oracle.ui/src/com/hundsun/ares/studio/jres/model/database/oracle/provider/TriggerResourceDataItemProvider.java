...
/**
 * This is the item provider adapter for a {@link com.hundsun.ares.studio.jres.model.database.oracle.TriggerResourceData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriggerResourceDataItemProvider
	 ...
	 * @generated
	 */
	public TriggerResourceDataItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TriggerResourceData_sql_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TriggerResourceData_sql_feature", "_UI_TriggerResourceData_type"),
	...
	/**
	 * This returns TriggerResourceData.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TriggerResourceData"));
	}
	...
	public String getText(Object object) {
		String label = ((TriggerResourceData)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TriggerResourceData_type") :
			getString("_UI_TriggerResourceData_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TriggerResourceData.class)) {
