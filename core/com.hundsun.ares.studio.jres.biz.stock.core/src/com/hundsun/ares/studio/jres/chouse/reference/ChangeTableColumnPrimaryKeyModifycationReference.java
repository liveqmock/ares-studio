 ...
 *
 */
public class ChangeTableColumnPrimaryKeyModifycationReference extends ModifyReference{

	private EList<CTCPMDetail> modifyDetails;
    private String stdOldValue;

	/**
	 * @param type
	 */
	public ChangeTableColumnPrimaryKeyModifycationReference(String type,String version,EList<CTCPMDetail> modifyDetails) {
		super(type);
	...
	public void setValue(String value) {
		if(this.modifyDetails!=null){
			for(ModifyDetail modifyDetail:modifyDetails){
