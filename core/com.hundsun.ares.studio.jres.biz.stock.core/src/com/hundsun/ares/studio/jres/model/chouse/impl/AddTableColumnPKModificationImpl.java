...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Add Table Column PK Modification</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.hundsun.ares.studio.jres.model.chouse.impl.AddTableColumnPKModificationImpl#getDetails <em>Details</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AddTableColumnPKModificationImpl extends ModificationImpl implements AddTableColumnPKModification {
	/**
	 ...
	 * @generated
	 */
	protected AddTableColumnPKModificationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ChousePackage.Literals.ADD_TABLE_COLUMN_PK_MODIFICATION;
	}
	...
	public EList<ModifyDetail> getDetails() {
		if (details == null) {
			details = new EObjectContainmentEList<ModifyDetail>(ModifyDetail.class, this, ChousePackage.ADD_TABLE_COLUMN_PK_MODIFICATION__DETAILS);
		}
		return details;
	}
	...
	public EList<Reference> getReferences() {
		...
		if(this.getDetails()!=null  &&  this.getDetails().size()>0 && StringUtils.isNotBlank(version)){
			AddTableColumnPKModificationReference addTableColumnPKModificationReference = new AddTableColumnPKModificationReference(IMetadataRefType.StdField,version,this.getDetails());
			references.add(addTableColumnPKModificationReference);
		}
		return references;
	}
...
} //AddTableColumnPKModificationImpl
