...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Change Table Column Unique Modifycation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.hundsun.ares.studio.jres.model.chouse.impl.ChangeTableColumnUniqueModifycationImpl#getDetails <em>Details</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ChangeTableColumnUniqueModifycationImpl extends ModificationImpl implements ChangeTableColumnUniqueModifycation {
	/**
	 ...
	 * @ordered
	 */
	protected EList<CTCUMDetail> details;
	 ...
	 * @generated
	 */
	protected ChangeTableColumnUniqueModifycationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ChousePackage.Literals.CHANGE_TABLE_COLUMN_UNIQUE_MODIFYCATION;
	}
	 ...
	 * @generated
	 */
	public EList<CTCUMDetail> getDetails() {
		if (details == null) {
			details = new EObjectContainmentEList<CTCUMDetail>(CTCUMDetail.class, this, ChousePackage.CHANGE_TABLE_COLUMN_UNIQUE_MODIFYCATION__DETAILS);
		}
		return details;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ChousePackage.CHANGE_TABLE_COLUMN_UNIQUE_MODIFYCATION__DETAILS:
				getDetails().clear();
				getDetails().addAll((Collection<? extends CTCUMDetail>)newValue);
				return;
		}
...
} //ChangeTableColumnUniqueModifycationImpl
