 ...
 *
 */
public class AddTableColumnPKModificationReference extends ModifyReference{

	private EList<ModifyDetail> modifyDetails;
    private String stdOldValue;

	/**
	 * @param type
	 */
	public AddTableColumnPKModificationReference(String type,String version,EList<ModifyDetail> modifyDetails) {
		super(type);
