...
public class FilteredTable extends Composite {
	 ...
	 *             look is encouraged
	 */
	public FilteredTable(Composite parent, int treeStyle, PatternFilter filter) {
	 ...
	 * @since 3.5
	 */
	public FilteredTable(Composite parent, int treeStyle, PatternFilter filter, boolean useNewLook) {
		super(parent, SWT.NONE);
		this.parent = parent;
...
//							if (item != null) {
//								table.select(item.getTable()) .setSelection( item );
...
.getImageRegistry().getDescriptor(DISABLED_CLEAR_ICON));
	...
	class NotifyingTableViewer extends TableViewer {
		...
		/* (non-Javadoc)
		 * @see org.eclipse.jface.viewers.AbstractTableViewer#insert(java.lang.Object, int)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see org.eclipse.jface.viewers.AbstractTableViewer#replace(java.lang.Object, int)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see org.eclipse.jface.viewers.AbstractTableViewer#clear(int)
		 */
		@Override
