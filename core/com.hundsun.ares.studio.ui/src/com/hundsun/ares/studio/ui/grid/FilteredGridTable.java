...
public class FilteredGridTable extends Composite {
	 ...
	 */
    private TablePattrenFilter patternFilter;
	 ...
	 */
	public FilteredGridTable(Composite parent, int treeStyle, TablePattrenFilter filter) {
	 ...
	 * @since 3.3
	 */
	protected void init(int treeStyle, TablePattrenFilter filter) {
	...
	private Grid createGrid(Composite parent, int style) {
		return new GridEx(parent, style);
	}
	 ...
	 */
	public final TablePattrenFilter getPatternFilter() {
