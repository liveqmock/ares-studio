 ...
 *
 */
public class ReourceNameModuleRootDuplicateValidator extends BaseWizardPageValidator  implements IWizardPageValidator{
	...
	public IStatus validate(Map<Object, Object> context) {
		...
		if (!(selection instanceof IARESModuleRoot)) {
			return getErrorStatus("请选择一个模块根");
		}

		IARESModuleRoot moduleRoot = (IARESModuleRoot) selection;
		IARESModule module = moduleRoot.getModule(IARESModule.DEFAULT_MODULE_NAME);
