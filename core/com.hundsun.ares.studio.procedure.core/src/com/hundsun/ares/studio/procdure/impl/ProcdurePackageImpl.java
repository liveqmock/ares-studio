...
public class ProcdurePackageImpl extends EPackageImpl implements ProcdurePackage {
	 ...
	 * @generated
	 */
	public EAttribute getProcedure_ProcName() {
		return (EAttribute)procedureEClass.getEStructuralFeatures().get(12);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(procedureEClass, PROCEDURE__PROC_NAME);
	...
	public void initializePackageContents() {
		...
		initEReference(getProcedure_InternalVariables(), this.getInternalParam(), null, "internalVariables", null, 0, -1, Procedure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProcedure_ProcName(), ecorePackage.getEString(), "procName", "", 0, 1, Procedure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
