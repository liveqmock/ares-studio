...
import com.hundsun.ares.studio.procdure.InternalParam;
 ...
 *   <li>{@link com.hundsun.ares.studio.procdure.impl.ProcedureImpl#getProcName <em>Proc Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcedureImpl extends BizInterfaceImpl implements Procedure {
	...
	/**
	 * The default value of the '{@link #getProcName() <em>Proc Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getProcName()
	 * @generated
	 * @ordered
	 */
	protected static final String PROC_NAME_EDEFAULT = "";

	/**
	 * The cached value of the '{@link #getProcName() <em>Proc Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getProcName()
	 * @generated
	 * @ordered
	 */
	protected String procName = PROC_NAME_EDEFAULT;
	...
	public EList<InternalParam> getInternalVariables() {
		if (internalVariables == null) {
			internalVariables = new EObjectContainmentEList<InternalParam>(InternalParam.class, this, ProcdurePackage.PROCEDURE__INTERNAL_VARIABLES);
		}
	 ...
	 * @generated
	 */
	public void setProcName(String newProcName) {
		String oldProcName = procName;
		procName = newProcName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcdurePackage.PROCEDURE__PROC_NAME, oldProcName, procName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ProcdurePackage.PROCEDURE__PROC_NAME:
				return getProcName();
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ProcdurePackage.PROCEDURE__AUTO_TRANSACTION:
				...
				return;
			case ProcdurePackage.PROCEDURE__PROC_NAME:
				setProcName(PROC_NAME_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ProcdurePackage.PROCEDURE__PROC_NAME:
				return PROC_NAME_EDEFAULT == null ? procName != null : !PROC_NAME_EDEFAULT.equals(procName);
		}
