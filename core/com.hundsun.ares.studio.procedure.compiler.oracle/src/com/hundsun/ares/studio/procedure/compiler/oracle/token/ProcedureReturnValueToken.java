...
public class ProcedureReturnValueToken implements ICodeToken {
	...
	public String genCode(Map<Object, Object> context) throws Exception {
		...
		if(StringUtils.equalsIgnoreCase(procedure.getBizType(), IProcedureEngineContextConstantOracle.function) &&
				StringUtils.equalsIgnoreCase(procedure.getReturnType(), IProcedureEngineContextConstantOracle.return_type)){
