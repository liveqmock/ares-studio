...
import com.hundsun.ares.studio.atom.compiler.token.NestPackAddValueToken;
...
public class NestPackAddValueMacroHandler implements IMacroTokenHandler{
	...
	public Iterator<ICodeToken> handle(IMacroToken token,
		...
		if (token.getParameters().length !=2) {
			...
			helper.addAttribute(IAtomEngineContextConstant.ATTR_OUT_OBJECT_INIT_VARIABLE_LIST, param2);//加入到要声明的对象输入对象列表中
