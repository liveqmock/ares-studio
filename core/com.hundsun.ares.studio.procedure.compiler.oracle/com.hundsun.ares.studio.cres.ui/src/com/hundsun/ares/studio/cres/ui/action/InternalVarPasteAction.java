 ...
 *
 */
public class InternalVarPasteAction extends ColumnViewerPasteAction {
	 ...
	 * @param reference
	 */
	public InternalVarPasteAction(ColumnViewer viewer,
		...
		protected List<EObject> getCopyedObjects() {
			...
			if (eObjects.isEmpty()) {
				...
				for (StandardField std : stds) {
					Parameter p = BizFactory.eINSTANCE.createParameter();
