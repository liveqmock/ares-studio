 ...
 *
 */
public class ProcedureRelatedBasicDataInfoSupportHelper extends JRESContentPorposalHelper implements IContentProposalProviderHelper{

	@Override
	protected IContentProposal getProposal(String contents, int position, EObject item, IARESResource resource) {
		if (item instanceof BasicDataBaseModel && resource != null) {
			BasicDataBaseModel table = (BasicDataBaseModel) item;
