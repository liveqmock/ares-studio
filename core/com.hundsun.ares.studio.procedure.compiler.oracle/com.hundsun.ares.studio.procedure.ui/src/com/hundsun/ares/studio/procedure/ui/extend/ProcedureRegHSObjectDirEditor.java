...
public class ProcedureRegHSObjectDirEditor  extends TextExtensionFieldEditor implements IProjectExtensibleStatus{
	...
	public ProcedureRegHSObjectDirEditor() {
		setId(IProcedureConstant.PROC_REG_HSOBJECT_DIR);
		setName("过程资源注册脚本:");
	}
			...
			public void widgetSelected(SelectionEvent e) {
				...
				CommonElementContentProvider cp = new CommonElementContentProvider(){
					...
					protected Object[] getProjectChildren(
						...
						return ProcedureRegHSObjectDirEditor.this.getProjectChildren(project);
					}
				};
				...
				fileDialog.setTitle("选择过程资源注册脚本");
