...
public class BizPropertyHandler extends EMFPropertyHandler {
	...
	/** 名称，中文名 */
	public static IPropertyHandler PARAM_NAME_PROPERTY_HANDLER = new EMFPropertyHandler(BizPackage.Literals.PARAMETER__NAME);
	/** 业务类型 */
	public static IPropertyHandler PARAM_TYPE_PROPERTY_HANDLER = new EMFPropertyHandler(BizPackage.Literals.PARAMETER__TYPE);
	/** 默认值 */
	...
	/** 描述 */
	public static IPropertyHandler PARAM_DESCRIPTION_HANDLER = new EMFPropertyHandler(BizPackage.Literals.PARAMETER__DESCRIPTION);
