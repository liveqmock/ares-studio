...
public class DbScriptTableDirEditor extends TextExtensionFieldEditor implements IProjectExtensibleStatus{

	private IARESProject project;
	Text txtPath;
	Button btnFile;
	
	public DbScriptTableDirEditor() {
		setId("tabledir");
		setName("数据表脚本:");
	}
			...
			public void widgetSelected(SelectionEvent e) {
				...
				CommonElementContentProvider cp = new CommonElementContentProvider(){
					...
					protected Object[] getProjectChildren(
						...
						return DbScriptTableDirEditor.this.getProjectChildren(project);
					}
				};
				...
				fileDialog.setTitle("选择"+ getName());
