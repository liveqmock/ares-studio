...
public class HanziToPingtin {
	 ...
	 * 
	 * @param cnStr
	 * @param upperCase 是否需要转化成大写 ，true：大写 ；false：小写
	 * @return
	 */
	public static String getFirstSpell(String cnStr , boolean upperCase) {
		StringBuffer sb = new StringBuffer();
		for (char s : cnStr.toCharArray()) {
			String ss = StringUtils.substring(HanziToPingtin.getFullSpell(String.valueOf(s)), 0, 1);
			if (upperCase) {
				ss = ss.toUpperCase();
			}
			sb.append(ss);
	...
	public static String removea_Za_z_(String cnStr ) {
		if(cnStr==null) return cnStr;
		StringBuffer sb = new StringBuffer("");
		for(int i=0;i<cnStr.length();i++){
			String str = cnStr.substring(i,i+1);
	...
	public static void main(String[] args) {
		String str = null;
		str = "黄德添_，， sajdsa【大骚动】";//
		System.out.println(removea_Za_z_(HanziToPingtin.getFirstSpell(str,false)));
		//System.out.println("Spell=" + HanziToPingtin.getFullSpell(str));
		//String str2 = HanziToPingtin.getFirstSpell(str,false);
		//System.out.println("Spell=" + str2);
