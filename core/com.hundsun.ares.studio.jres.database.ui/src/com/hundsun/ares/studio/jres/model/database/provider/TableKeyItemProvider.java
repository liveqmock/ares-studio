...
/**
 * This is the item provider adapter for a {@link com.hundsun.ares.studio.jres.model.database.TableKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableKeyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TableKey_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TableKey_name_feature", "_UI_TableKey_type"),
				 DatabasePackage.Literals.TABLE_KEY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TableKey_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TableKey_type_feature", "_UI_TableKey_type"),
				 DatabasePackage.Literals.TABLE_KEY__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addColumnsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TableKey_columns_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TableKey_columns_feature", "_UI_TableKey_type"),
				 DatabasePackage.Literals.TABLE_KEY__COLUMNS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMarkPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TableKey_mark_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TableKey_mark_feature", "_UI_TableKey_type"),
				 DatabasePackage.Literals.TABLE_KEY__MARK,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatabasePackage.Literals.TABLE_KEY__FOREIGN_KEY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DatabasePackage.Literals.TABLE_KEY__FOREIGN_KEY,
