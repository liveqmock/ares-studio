...
public class FilteredTable extends Composite {
	 ...
	 */
    private HSTableFilter patternFilter;
	 ...
	 */
	public FilteredTable(Composite parent, int treeStyle, HSTableFilter filter) {
	 ...
	 * @since 3.3
	 */
	protected void init(int treeStyle, HSTableFilter filter) {
     ...
     */
    private TableItem getFirstMatchingItem(TableViewer viewer, TableItem[] items){
				...
				if (e.detail == SWT.TRAVERSE_RETURN) {
					...
					if (getViewer().getTable().getItemCount() == 0) {
						...
						if (hasFocus && textChanged
							...
							TableItem item = getFirstMatchingItem(tableViewer, getViewer().getTable().getItems());
							if (item != null) {
	...
	protected Text doCreateFilterText(Composite parent) {
		...
		return toolkit.createText(parent, "", SWT.SINGLE | SWT.BORDER | SWT.SEARCH | SWT.CANCEL);
	 ...
	 */
	public final HSTableFilter getPatternFilter() {
	 ...
	 * @return bold font
	 */
	public static Font getBoldFont(Object element, FilteredTable table,
			PatternFilter filter) {
