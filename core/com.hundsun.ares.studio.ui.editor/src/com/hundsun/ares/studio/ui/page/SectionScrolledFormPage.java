 ...
 *
 */
public abstract class SectionScrolledFormPage<T> extends
		FromPageWithMyDirtySystem<T> {

	public SectionScrolledFormPage(FormEditor editor, String id, String title) {
	...
	protected Layout getFormLayout(){
		return FormLayoutFactory.createSectionClientTableWrapLayout(false, 1);
	}
	...
	public Section createCompositeSection(String title,boolean expanded,Layout layout){
		Section section = createSectionWithTitle(formComposite, formToolkit, title, expanded,getDefaultLayoutData());
	 ...
	 * @return
	 */
	protected Object getDefaultLayoutData(){
		return new TableWrapData(TableWrapData.FILL_GRAB);
	}
	
	protected void refreshSection(Section section){
