...
public class ProcedureParametersDefineToken implements ICodeToken {
	...
	public String genCode(Map<Object, Object> context) throws Exception {
		...
		this.notDefineConnectType = (Boolean) context.get(IProcedureEngineContextConstant.not_define_connect_type);
		...
		for(Parameter parameter: totleInputParam){
			if(!parameters.contains(parameter.getId())){
				...
				helper.addAttribute(IProcedureEngineContextConstant.ATTR_IN_OUT_PARAM_LIST, parameter.getId());
		...
		if(procedure.isOutputCollection()) {
			...
			//游标变量
				...
				helper.addAttribute(IProcedureEngineContextConstant.ATTR_IN_OUT_PARAM_LIST, "cursor");
