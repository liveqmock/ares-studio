...
import com.hundsun.ares.studio.procedure.compiler.token.SubProcedureCallToken;
...
public class ProcedureCallMacroHandler implements IMacroTokenHandler {
	...
	private Procedure getSubProcedure(String name,Map<Object, Object> context){
		...
		IProcedureMacroTokenService service =(IProcedureMacroTokenService) context.get(IProcedureEngineContextConstant.Procedure_Macro_Service);
		try {
	...
	private void addToPVarList(Map<Object, Object> context ,String name){
		...
		List<String> popVarList = (List<String>)context.get(IEngineContextConstant.PSEUDO_CODE_PARA_LIST);
			helper.addAttribute(IProcedureEngineContextConstant.ATTR_PROC_VARIABLE_LIST, name);
			popVarList.add(name);
