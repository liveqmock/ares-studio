...
public class ProcedureIntoHsobjectToken implements ICodeToken {
	...
	public String genCode(Map<Object, Object> context) throws Exception {
		...
		IOracleDBService oracleService = DataServiceManager.getInstance().getService((IARESProject)context.get(IProcedureEngineContextConstant.Aresproject), IOracleDBService.class);
