...
public interface BizPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ERROR_INFO__DATA = MetadataPackage.ERROR_NO_ITEM__DATA;
	 ...
	 * @ordered
	 */
	int ERROR_INFO__DATA2 = MetadataPackage.ERROR_NO_ITEM__DATA2;
	 ...
	 * @ordered
	 */
	int ERROR_INFO__NAME = MetadataPackage.ERROR_NO_ITEM__NAME;
	 ...
	 * @ordered
	 */
	int ERROR_INFO__CHINESE_NAME = MetadataPackage.ERROR_NO_ITEM__CHINESE_NAME;
	 ...
	 * @ordered
	 */
	int ERROR_INFO__DESCRIPTION = MetadataPackage.ERROR_NO_ITEM__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int ERROR_INFO__REF_ID = MetadataPackage.ERROR_NO_ITEM__REF_ID;
	 ...
	 * @ordered
	 */
	int ERROR_INFO__PARENT = MetadataPackage.ERROR_NO_ITEM__PARENT;
	 ...
	 * @ordered
	 */
	int ERROR_INFO__NO = MetadataPackage.ERROR_NO_ITEM__NO;
	 ...
	 * @ordered
	 */
	int ERROR_INFO__MESSAGE = MetadataPackage.ERROR_NO_ITEM__MESSAGE;
	 ...
	 * @ordered
	 */
	int ERROR_INFO__CONSTANT_NAME = MetadataPackage.ERROR_NO_ITEM__CONSTANT_NAME;
	 ...
	 * @ordered
	 */
	int ERROR_INFO__LEVEL = MetadataPackage.ERROR_NO_ITEM__LEVEL;
	 ...
	 * @ordered
	 */
	int ERROR_INFO_FEATURE_COUNT = MetadataPackage.ERROR_NO_ITEM_FEATURE_COUNT + 0;
