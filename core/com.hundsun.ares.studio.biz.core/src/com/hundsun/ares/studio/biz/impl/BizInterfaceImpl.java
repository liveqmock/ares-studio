...
public class BizInterfaceImpl extends EObjectImpl implements BizInterface {
	 ...
	 * @ordered
	 */
	protected EList<ErrorInfo> errorInfos;
	 ...
	 * @generated
	 */
	public EList<ErrorInfo> getErrorInfos() {
		if (errorInfos == null) {
			errorInfos = new EObjectContainmentEList<ErrorInfo>(ErrorInfo.class, this, BizPackage.BIZ_INTERFACE__ERROR_INFOS);
		}
		return errorInfos;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case BizPackage.BIZ_INTERFACE__ERROR_INFOS:
				getErrorInfos().clear();
				getErrorInfos().addAll((Collection<? extends ErrorInfo>)newValue);
				return;
		}
