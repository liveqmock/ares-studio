...
public class BizValidator extends EObjectValidator {
	...
	public BizValidator() {
		super();
		metadataValidator = MetadataValidator.INSTANCE;
	}
	...
	public boolean validateErrorInfo(ErrorInfo errorInfo, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(errorInfo, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= metadataValidator.validateErrorNoItem_name(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= metadataValidator.validateErrorNoItem_refId(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= metadataValidator.validateErrorNoItem_constantName(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= metadataValidator.validateErrorNoItem_message(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= metadataValidator.validateErrorNoItem_no(errorInfo, diagnostics, context);
		if (result || diagnostics != null) result &= metadataValidator.validateErrorNoItem_level(errorInfo, diagnostics, context);
		return result;
	}
