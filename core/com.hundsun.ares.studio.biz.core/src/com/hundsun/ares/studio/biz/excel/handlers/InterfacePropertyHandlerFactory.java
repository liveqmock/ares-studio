...
public class InterfacePropertyHandlerFactory extends ExtensiblePropertyHandlerFactory implements IPropertyHandlerFactory {
	...
	static {
		...
		INTERFACE_PROPERTY_HANDLERS.put("函数名称", EMFPropertyHandler.NAME_PROPERTY_HANDLER);//恒生开发工具导出的格式中，函数名称对应英文名
		INTERFACE_PROPERTY_HANDLERS.put("过程名", EMFPropertyHandler.NAME_PROPERTY_HANDLER);
		INTERFACE_PROPERTY_HANDLERS.put("过程名称", EMFPropertyHandler.NAME_PROPERTY_HANDLER);//恒生开发工具导出的格式中，过程名称对应英文名
		INTERFACE_PROPERTY_HANDLERS.put("对象中文名", EMFPropertyHandler.NAME_PROPERTY_HANDLER);
		...
		INTERFACE_PROPERTY_HANDLERS.put("服务名称", EMFPropertyHandler.CNAME_PROPERTY_HANDLER);//恒生开发工具导出的格式中，服务名称对应中文名
		INTERFACE_PROPERTY_HANDLERS.put("服务说明", EMFPropertyHandler.CNAME_PROPERTY_HANDLER);
		INTERFACE_PROPERTY_HANDLERS.put("结果集返回", new BooleanEMFPropertyHandler(BizPackage.Literals.BIZ_INTERFACE__OUTPUT_COLLECTION, BooleanEMFPropertyHandler.STYLE_CN));
