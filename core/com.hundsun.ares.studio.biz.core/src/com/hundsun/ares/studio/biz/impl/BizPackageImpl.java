...
public class BizPackageImpl extends EPackageImpl implements BizPackage {
	...
	public void initializePackageContents() {
		...
		errorInfoEClass.getESuperTypes().add(theMetadataPackage.getErrorNoItem());
		...
		initEReference(getBizInterface_ErrorInfos(), this.getErrorInfo(), null, "errorInfos", null, 0, -1, BizInterface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
